...
<body>
<?php
// Definimos el nombre del fichero de usuarios La estructura de cada línea es:
//USUARIO | PASSWORD
...
<form name='f1' action='ficheros01.php' method='POST'>
...
fclose($fich);
// Cerramos el fichero
echo "<br>Pulsa <a href='ficheros01.php'>aquí</a> para continuar..."; // Mostramos un enlace al propio script
}
?>
</body>
</html>
